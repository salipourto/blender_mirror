...
class hiprtGeomTraversalClosest
{
  public:
	...
	hiprtPimpl<hiprtGeomTraversal_impl<hiprtTriangleNode, hiprtTraversalTerminateAtClosestHit>,
		SIZE_GEOM_TRAVERSAL_PRIVATE_STACK, ALIGNMENT_GEOM_TRAVERSAL_PRIVATE_STACK> m_impl;
};
...
class hiprtSceneTraversalClosest
{
  public:
	...
	hiprtPimpl<hiprtSceneTraversal_impl<hiprtTraversalTerminateAtClosestHit>,
		SIZE_SCENE_TRAVERSAL_PRIVATE_STACK, ALIGNMENT_SCENE_TRAVERSAL_PRIVATE_STACK> m_impl;
};
...
class hiprtGeomTraversalClosestCustomStack
{
  public:
	...
	private:
	hiprtPimpl<hiprtGeomTraversalCustomStack_impl<hiprtStack, hiprtTriangleNode, hiprtTraversalTerminateAtClosestHit>,
		SIZE_GEOM_TRAVERSAL_CUSTOM_STACK, ALIGNMENT_GEOM_TRAVERSAL_CUSTOM_STACK> m_impl;
};
...
class hiprtGeomTraversalAnyHitCustomStack
{
  public:
	...
	private:
	hiprtPimpl<hiprtGeomTraversalCustomStack_impl<hiprtStack, hiprtTriangleNode, hiprtTraversalTerminateAtAnyHit>,
		SIZE_GEOM_TRAVERSAL_CUSTOM_STACK, ALIGNMENT_GEOM_TRAVERSAL_CUSTOM_STACK> m_impl;
};
...
class hiprtGeomCustomTraversalClosestCustomStack
{
  public:
	...
	private:
	hiprtPimpl<hiprtGeomTraversalCustomStack_impl<hiprtStack, hiprtCustomNode, hiprtTraversalTerminateAtClosestHit>,
		SIZE_GEOM_TRAVERSAL_CUSTOM_STACK, ALIGNMENT_GEOM_TRAVERSAL_CUSTOM_STACK> m_impl;
};
...
class hiprtGeomCustomTraversalAnyHitCustomStack
{
  ...
  private:
	hiprtPimpl<hiprtGeomTraversalCustomStack_impl<hiprtStack, hiprtCustomNode, hiprtTraversalTerminateAtAnyHit>,
		SIZE_GEOM_TRAVERSAL_CUSTOM_STACK, ALIGNMENT_GEOM_TRAVERSAL_CUSTOM_STACK> m_impl;
};
...
class hiprtSceneTraversalClosestCustomStack
{
  public:
	...
	hiprtPimpl<hiprtSceneTraversalCustomStack_impl<hiprtStack, hiprtTraversalTerminateAtClosestHit>,
		SIZE_SCENE_TRAVERSAL_CUSTOM_STACK, ALIGNMENT_SCENE_TRAVERSAL_CUSTOM_STACK> m_impl;
};
