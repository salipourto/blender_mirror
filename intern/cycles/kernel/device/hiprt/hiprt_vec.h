...
HIPRT_HOST_DEVICE HIPRT_INLINE hiprtInt2 make_hiprtInt2(int x, int y)
{
  return {x, y};
}

HIPRT_HOST_DEVICE HIPRT_INLINE hiprtFloat2 make_hiprtFloat2(float x, float y)
{
  return {x, y};
}

HIPRT_HOST_DEVICE HIPRT_INLINE hiprtInt3 make_hiprtInt3(int x, int y, int z)
{
  return {x, y, z};
}

HIPRT_HOST_DEVICE HIPRT_INLINE hiprtFloat3 make_hiprtFloat3(float x, float y, float z)
{
  return {x, y, z};
}

HIPRT_HOST_DEVICE HIPRT_INLINE hiprtInt4 make_hiprtInt4(int x, int y, int z, int w)
{
  return {x, y, z, w};
}

HIPRT_HOST_DEVICE HIPRT_INLINE hiprtFloat4 make_hiprtFloat4(float x, float y, float z, float w)
{
  return {x, y, z, w};
}

HIPRT_HOST_DEVICE HIPRT_INLINE hiprtUint2 make_hiprtUint2(unsigned int x, unsigned int y)
{
  return {x, y};
}
